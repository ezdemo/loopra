...
.desktop-home-search input { min-width: 0; flex: 1; border: 0; outline: 0; background: transparent; color: var(--fg, #27272a); font: inherit; font-size: var(--font-ui-size, 14px); }
...
.desktop-search-result { width: 100%; min-height: 38px; display: flex; align-items: center; gap: 11px; padding: 0 11px; border: 0; border-radius: 11px; background: transparent; color: var(--fg-2, #52525b); font: inherit; font-size: var(--font-ui-size, 14px); text-align: left; cursor: pointer; transition: background-color .12s ease, color .12s ease; }
...
.desktop-home-heading { min-height: 32px; display: flex; align-items: center; justify-content: space-between; margin-bottom: 4px; color: var(--fg, #27272a); font-size: var(--font-ui-size, 14px); font-weight: 600; flex: 0 0 auto; order: 1; }.desktop-home-heading > span { min-width: 0; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
...
.desktop-sidebar-scroll::-webkit-scrollbar-track, .desktop-sidebar-scroll::-webkit-scrollbar-track-piece, .desktop-sidebar-scroll::-webkit-scrollbar-corner, .desktop-project-list::-webkit-scrollbar-track, .desktop-project-list::-webkit-scrollbar-track-piece, .desktop-session-timeline::-webkit-scrollbar-track, .desktop-session-timeline::-webkit-scrollbar-track-piece, .desktop-project-list::-webkit-scrollbar-corner, .desktop-session-timeline::-webkit-scrollbar-corner { background: transparent; border: 0; }
    ...
    .desktop-project { width: 100%; min-height: 38px; display: flex; align-items: center; gap: 8px; border: 0; border-radius: 8px; background: transparent; color: var(--fg-2, #52525b); font: inherit; font-size: var(--font-ui-size, 14px); line-height: var(--font-ui-line-height, 20px); text-align: left; cursor: pointer; padding: 0 10px; box-sizing: border-box; transition: background-color var(--t), color var(--t); }
...
.desktop-project-footer-more { position: relative; width: 100%; flex: 0 0 auto; order: 0; }
    .desktop-project-footer button { height: 32px; display: flex; align-items: center; gap: 8px; padding: 0 8px; border: 0; border-radius: 8px; background: transparent; color: var(--fg-3, #71717a); font: inherit; font-size: var(--font-ui-size, 14px); line-height: var(--font-ui-line-height, 20px); cursor: pointer; transition: background-color var(--t), color var(--t); }
...
.desktop-footer-more-menu :deep(.tb-service-btn),
.desktop-home-muted,
.desktop-rename-dialog h3,
.desktop-rename-dialog input,
.desktop-rename-actions button {
