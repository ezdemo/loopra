...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  desktopChatTabs: {
    ...
    startSidebarResize: () => ipcRenderer.invoke('desktop-chat-tab-sidebar-resize-start'),
    endSidebarResize: () => ipcRenderer.invoke('desktop-chat-tab-sidebar-resize-end-request'),
    reportSidebarResizeMove: (payload) => ipcRenderer.send('desktop-chat-tab-sidebar-resize-move', toPlainIpcValue(payload)),
    reportSidebarResizeEnd: () => ipcRenderer.send('desktop-chat-tab-sidebar-resize-end'),
