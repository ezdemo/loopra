#
# Loopra Web Installer for Windows (Mirror via GitHub + gh-proxy)
# Usage: irm https://gh-proxy.org/https://github.com/ezdemo/loopra/releases/download/v26.8.3.1/setup-mirror.ps1 | iex
#
